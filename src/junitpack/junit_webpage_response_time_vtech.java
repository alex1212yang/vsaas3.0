...
public class junit_webpage_response_time_vtech extends TestCase{

	//次數
	public junit_webpage_response_time_vtech(String name)  
    {  
        super(name);  
    }  
    ...
    {  
        ...
        suite.addTest(new RepeatedTest(new junit_webpage_response_time_vtech("test"), 50));  
        return suite;  
    }
